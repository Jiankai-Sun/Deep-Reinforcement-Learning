...
Reference: https://github.com/MorvanZhou/Reinforcement-learning-with-tensorflow/blob/master/contents/5.3_Dueling_DQN/RL_brain.py
...
class DuelingDQN:
    ...
    def choose_action(self, observation):
        ...
        if np.random.uniform() < self.epsilon: # choose action
