...
class PolicyGradient:
    ...
    def _build_net(self):
        ...
        layer = tf.layers.dense(
            inputs = self.tf_obs,
            units = 10,
            activation = tf.nn.tanh, # tahn activation
        ...
        with tf.name_scope('loss'):
            ...
            neg_log_prob = tf.nn.sparse_softmax_cross_entropy_with_logits(logits=all_act, labels = self.tf_acts) # this is negative log of
            # or in this way:
