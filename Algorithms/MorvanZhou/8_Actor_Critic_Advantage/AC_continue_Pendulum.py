...
Reference: https://github.com/MorvanZhou/Reinforcement-learning-with-tensorflow/blob/master/contents/8_Actor_Critic_Advantage/AC_continue_Pendulum.py
...
class Actor(object):
    def __init__(self, sess, n_features, action_bound, lr = 0.0001):
        ...
        l1 = tf.layers.dense(
            inputs = self.s,
            units = 30, # the number of hidden units
...
MAX_EPISODE = 1000
MAX_EP_STEPS = 300
DISPLAY_REWARD_THRESHOLD = -550 # renders environment if total episode reward is greater than this threshold
